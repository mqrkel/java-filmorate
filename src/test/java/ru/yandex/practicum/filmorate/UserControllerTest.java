...
//                .build();
//
//        when(userService.getUserById(1)).thenReturn(responseUserDto);
//
...
//        when(userService.getUserById(999)).thenThrow(new NotFoundException("Пользователь с id=999 не найден"));
//
